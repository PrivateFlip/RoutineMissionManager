        ...
        public override void WindowUI()
        {
            ...
            if (ActiveTrackings != null && ActiveTrackings.Count != 0)
            {
                foreach (Tracking tracking in ActiveTrackings)
                {
                    ...
                    {
                        _trackingControl.TrackingDetail(tracking.Mission, this);
                    }
                    ...
                    if (GUILayout.Button("abort", RmmStyle.Instance.ButtonStyle, GUILayout.Width(55), GUILayout.Height(22)))
                    {
                        tracking.AbortTracking();
                    }
                    GUILayout.EndHorizontal();
